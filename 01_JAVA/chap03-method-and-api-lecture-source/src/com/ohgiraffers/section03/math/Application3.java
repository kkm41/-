package src.com.ohgiraffers.section03.math;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*random.nextInt(구하려는 난수의 객수) + 구하려는 난수의 최소값*/

        Random ran = new Random(); //import 가져옴
        ...
        /*2. 1부터 10까지 난수발생 */
        int randomNum2 = ran.nextInt(10)+1;
        System.out.println("1부터 10까지의 난수 ? : " + randomNum2);

        /*3. 20부터 45까지 난수발생*/
        int randomNum3 = ran.nextInt(26) +20;
        System.out.println("20부터 45까지의 난수 ? :" + randomNum3);

        /* 4. -128 ~ 127까지 난수발생 */
        //int randomNum4 = ran.nextInt(256) - 128;
        int randomNum5 = new Random().nextInt(256) - 128; //객체를 생성하자마자 바로 메소드 호출 가능
        System.out.println("-128 ~ 127까지의 난수발생 " + randomNum5);
    }
}
