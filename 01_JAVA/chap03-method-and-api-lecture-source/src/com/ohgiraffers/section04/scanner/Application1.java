package src.com.ohgiraffers.section04.scanner;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        java.util.Scanner sc = new java.util.Scanner(java.lang.System.in); //java.lang은 생략 가능, 이건 너무 길다

        /*1-2 다른 클래스에 클래스 사용 시 패키지명 생략하기 위해 사용하는구문 사용(import)*/

        Scanner sc1 = new Scanner(System.in); //위에 자동으로 import java.util.Scanner; 생김
        ...
        /*2-3 실수값 입력받기*/
        /*netDouble : 입력받은 값을 double형으로 반환한다*/

        System.out.print("원하는 실수를 입력해주세요 : ");
        double dnum = sc.nextDouble();
        System.out.println("입력한 실수값은" +dnum+ "입니다");
